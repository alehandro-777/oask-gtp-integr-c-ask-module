...
exports.getCentrAskHourData = (line_id, dt_start_time, dt_end_time) => {
    ...
    console.log(`${url}/getdata/fmhour/?${line_id}&dtBegin=${start}&dtEnd=${end}`)
    return axios.get(`${url}/getdata/fmhour/?${line_id}&dtBegin=${start}&dtEnd=${end}`);
  }
...
function FormatAskDateTime(time) {
  ...
  //12/01/2020 07:00:00
  return `${mn+1}/${dd}/${yyyy}T${hh}:${mm}:${ss}`
}
